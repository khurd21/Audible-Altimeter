...
AUDIO_ARRAY_DIRECTORY = os.path.join(os.getcwd(), "Audible-Altimeter", "src")


AUDIO_SAMPLES_HEADER_FILE_NAME = "audio_samples"
AUDIO_SAMPLE_ID_HEADER_FILE_NAME = "sample_id"

AUDIO_SAMPLES_HEADER_FILE_PATH = os.path.join(os.getcwd(), "Audible-Altimeter", "src")
AUDIO_SAMPLE_ID_HEADER_FILE_PATH = os.path.join(os.getcwd(), "Audible-Altimeter", "include", "Audible-Altimeter")
...
'''
    header_file_contents += f'constexpr std::size_t _TOTAL_NUMBER_OF_BYTES {{ {TOTAL_NUMBER_OF_BYTES} }};\n\n'
...
def create_header_file_for_samples(samples: list[SampleMetadata]):
    header_file_path = os.path.abspath(os.path.join(AUDIO_ARRAY_DIRECTORY, f'{AUDIO_SAMPLES_HEADER_FILE_NAME}.hpp'))
    header_file_contents = generated_warning
    header_file_contents += f'''
...
'''
    header_file_contents += f'constexpr std::size_t TOTAL_NUMBER_OF_BYTES {{ {TOTAL_NUMBER_OF_BYTES} }};\n'
...
def create_cmake_file(samples: list[SampleMetadata]):
    print("do not call this function, it's not done")
    return
...
set(SOURCES
    {AUDIO_SAMPLES_HEADER_FILE_NAME}.h
'''
