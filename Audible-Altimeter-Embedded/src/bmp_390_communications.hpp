...
#ifndef AUDIBLE_ALTIMETER_EMBEDDED_BMP3_COMMUNICATIONS
#define AUDIBLE_ALTIMETER_EMBEDDED_BMP3_COMMUNICATIONS
 ...
 */
extern "C" BMP3_INTF_RET_TYPE bmp3_interface_init(bmp3_dev* bmp3,
                                                  std::uint8_t intf);
 ...
 *
 */
extern "C" BMP3_INTF_RET_TYPE bmp3_i2c_read(std::uint8_t reg_addr,
 ...
 *
 */
extern "C" BMP3_INTF_RET_TYPE bmp3_i2c_write(std::uint8_t reg_addr,
 ...
 *
 */
extern "C" BMP3_INTF_RET_TYPE bmp3_spi_read(std::uint8_t reg_addr,
                                            std::uint8_t* reg_data,
                                            std::uint32_t len, void* intf_ptr);
 ...
 *
 */
extern "C" BMP3_INTF_RET_TYPE bmp3_spi_write(std::uint8_t reg_addr,
 ...
 *
 */
extern "C" void bmp3_delay_us(std::uint32_t period, void* intf_ptr);
 ...
 *  @return void.
 */
extern "C" void bmp3_check_rslt(const char api_name[], std::int8_t rslt);
 ...
 *  @return void.
 */
extern "C" void bmp3_deinit();

}  // namespace altimeter

#endif /* AUDIBLE_ALTIMETER_EMBEDDED_BMP3_COMMUNICATIONS */